...
/**
* replace_value - this replaces the value at a pre-existing key
* @ht: is the double pointer to the hash_node_t list
* @key: is a new key to add in the node
* @value: is the value to add in the node
*/
...
/**
* check_key - function checks if a key exists in a hash table
* @ht: is the pointer to the hash_node_t list
* @key: is the key to look for
* Return: returns 1 if the key is found, 0 otherwise
*/
...
* @key: is the new key to add in the node
* @value: is the value to add in the node
